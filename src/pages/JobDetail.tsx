  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-6">
      ...
      <div className="mb-5 flex items-start justify-between gap-4">
        <div className="min-w-0">
          <div className="flex items-center gap-3">
            <h1 className="truncate text-xl font-semibold tracking-tight text-fg">{job.title}</h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="mb-5 h-10 w-full justify-start rounded-lg bg-transparent p-0">
          {tabDefs.map((t) => (
            <TabsTrigger
              key={t.value}
              value={t.value}
              className="data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-fg rounded-none border-b-2 border-transparent px-3 pb-2 pt-1"
            >
